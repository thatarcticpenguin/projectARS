...
const PatientForm = ({ onSubmit }) => {
  ...
  const departmentData = {
    general_medicine: ["Unknown/Trauma", "Unconscious", "Severe Fever"],
    cardiology: ["Heart Attack", "Cardiac Arrest", "Chest Pain"],
    neurology: ["Stroke", "Seizure", "Head Trauma"],
    orthopedics: ["Fracture", "Spinal Injury"],
  };
  ...
  const handleInstantRescue = () => {
    ...
    if (!finalLocation) {
      setError("⚠ Please enter emergency location");
      return;
    }
    setError("");
    setLoading(true);
              ...
              {filteredLocations.length === 0 ? (
                ...
                filteredLocations.map((loc) => (
                  <div
                    ...
                    style={{
                      ...styles.dropdownItem,
                      background: selectedLocation?.id === loc.id ? "#e0f2fe" : "transparent",
                    }}
                  >
                    {loc.name}
                  </div>
